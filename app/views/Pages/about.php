        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="home_ab_img">
                    <img class="wow fadeInUp" data-wow-delay="500ms" src="<?= BASEURL; ?>/assets/images/about/about_man.png"
                         alt=""/>
                </div>
            </div>
            <div class="col-lg-6">
...
<section class="about_cronacvirus_promo_area">
    <ul class="list-unstyled shap_img">
        <li><img src="<?= BASEURL; ?>/assets/images/about/promo_bg_shap3.png" alt=""></li>
        <li><img src="<?= BASEURL; ?>/assets/images/about/promo_bg_shap2.png" alt=""></li>
        <li><img src="<?= BASEURL; ?>/assets/images/about/promo_bg_shap1.png" alt=""></li>
    </ul>
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
    ...
    <div class="bg_img">
        <img class="shap" src="<?= BASEURL; ?>/assets/images/about/about_promo_bg.png" alt="">
        <ul class="list-unstyled shap_img_two">
            <li><img src="<?= BASEURL; ?>/assets/images/about/promo_bg_shap8.png" alt=""></li>
            <li><img src="<?= BASEURL; ?>/assets/images/about/promo_bg_shap7.png" alt=""></li>
            <li><img src="<?= BASEURL; ?>/assets/images/about/promo_bg_shap6.png" alt=""></li>
            <li data-parallax='{"y": 50}'><img src="<?= BASEURL; ?>/assets/images/about/promo_bg_shap5.png" alt=""></li>
            <li data-parallax='{"x": 50}'><img src="<?= BASEURL; ?>/assets/images/about/promo_bg_shap4.png" alt=""></li>
        </ul>
    </div>
</section>
...
<section class="about_faq_area">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="faq_img">
                    <img src="<?= BASEURL; ?>/assets/images/about/faq_img.jpg" alt=""/>
                </div>
            </div>
            <div class="col-lg-6">
