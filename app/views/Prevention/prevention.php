<section class="prevention_banner">
    <div class="container">
        <div class="prevention_text">
            <h6 class="wow fadeInUp">Apa yang harus dilakukan</h6>
            <h3 class="wow fadeInUp" data-wow-delay="0.2s">Bagaimana cara mencegah COVID-19?</h3>
        ...
        <div class="row protect_inner flex-row-reverse">
            <div class="col-lg-6">
                <div class="main_title">
                    ...
                    <h2>Bagaimana cara melindungi diri?</h2>
                </div>
                <div class="row protect_list_inner">
                    <div class="col-6">
                        <div class="protect_list_item">
                            <div class="protect_list_title">
                                <h3>Kamu harus melakukan</h3>
                                <h6>Pastikan mengikutinya</h6>
                            </div>
            ...
            <div class="col-lg-6">
                <div class="protect_img">
                    <img class="img-fluid" src="<?= BASEURL; ?>/assets/images/protect-img-2.png" alt=""/>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="prevent_item_inner row">
                    <div class="col-sm-6">
                        <div class="prevent_item wow fadeInUp">
                            <div class="prevent_img">
                                <img class="img-fluid" src="<?= BASEURL; ?>/assets/images/prevent/prevent-1.png" alt=""/>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="prevent_item wow fadeInUp" data-wow-delay="0.2s">
                            <div class="prevent_img">
                                <img class="img-fluid" src="<?= BASEURL; ?>/assets/images/prevent/prevent-2.png" alt=""/>
                            </div>
                            <div class="prevent_text">
                    ...
                    <div class="col-sm-6">
                        <div class="prevent_item wow fadeInUp" data-wow-delay="0.4s">
                            <div class="prevent_img">
                                <img class="img-fluid" src="<?= BASEURL; ?>/assets/images/prevent/prevent-3.png" alt=""/>
                            </div>
                            <div class="prevent_text">
                    ...
                    <div class="col-sm-6">
                        <div class="prevent_item wow fadeInUp" data-wow-delay="0.6s">
                            <div class="prevent_img">
                                <img class="img-fluid" src="<?= BASEURL; ?>/assets/images/prevent/prevent-4.png" alt=""/>
                            </div>
                            <div class="prevent_text">
