    ...
    <div class="canvus_menu_area">
        ...
        <div class="menu_part_lux">
            <ul class="menu_list wd_scroll">
                ...
                <li class="active">
                    <a href="<?= BASEURL; ?>/Prevention">Prevention
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            <li><a href="<?= BASEURL; ?>/Home"><i class="linearicons-arrow-left"></i> Back to Homepage</a>
                            </li>
                        </ul>
    ...
    <div class="pagepiling">
        <div class="pp-scrollable section active">
            <div class="scroll-wrap">
                <div class="p-section-bg" style="background-image:url('<?= BASEURL; ?>/assets/images/checker_map.png');">
                </div>
                        ...
                        <div class="virus_checker_content">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><i class="linearicons-ambulance"></i><span>Seizure (fit): </span> someone is
                                    ...
                                    is unconscious (can’t be woken up).
                                </li>
                            </ul>
        ...
        <div class="pp-scrollable section">
            <div class="scroll-wrap">
                <div class="p-section-bg" style="background-image:url('<?= BASEURL; ?>/assets/images/checker_map.png');"></div>
                <div class="scrollable-content">
                    <div class="container">
                        <div class="virus_checker_content">
                            ...
                            <div class="row virus_symptom_inner">
                                <div class="col-md-6">
                                    <div class="media virus_symptom">
                                        <div class="round_img">
                                            <img src="<?= BASEURL; ?>/assets/images/fever.png" alt="">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="media virus_symptom">
                                        <div class="round_img">
                                            <img src="<?= BASEURL; ?>/assets/images/cough.png" alt="">
                                        </div>
                                        <div class="media-body">
            ...
            <div class="scroll_body">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><i class="linearicons-arrow-right"></i>If <span>they develop fever or cough</span> during
                        that
                        time they should complete this form.
                    </li>
