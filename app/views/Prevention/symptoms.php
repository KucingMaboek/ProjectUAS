        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="home_ab_img text-center apps_craft_animation">
                    <img class="wow fadeInUp" data-wow-delay="400ms" src="<?= BASEURL; ?>/assets/images/symptom/man_img.png"
                         alt=""/>
                    <img class="covid_img one" src="<?= BASEURL; ?>/assets/images/symptom/covid1.png" alt=""/>
                    <img class="covid_img two" src="<?= BASEURL; ?>/assets/images/symptom/covid2.png" alt=""/>
                    <img class="covid_img three" src="<?= BASEURL; ?>/assets/images/symptom/covid3.png" alt=""/>
                    <img class="covid_img four" src="<?= BASEURL; ?>/assets/images/symptom/covid4.png" alt=""/>
                    <div class="covid_img five">
                        <img class="layer layer2" data-depth="0.5" src="<?= BASEURL; ?>/assets/images/symptom/covid5.png" alt=""/>
                    </div>
                    <div class="covid_img six">
                        <img class="layer layer2" data-depth="0.3" src="<?= BASEURL; ?>/assets/images/symptom/covid6.png" alt=""/>
                    </div>
                    <img class="covid_img seven" src="<?= BASEURL; ?>/assets/images/symptom/covid7.png" alt=""/>
                    <img class="covid_img eight" src="<?= BASEURL; ?>/assets/images/symptom/covid8.png" alt=""/>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="home_ab_text">
                    <div class="home_ab_text_inner symptoms_about_inner">
                        <div class="home_ab_item">
                            ...
                            <a class="green_btn wow fadeInUp" data-wow-delay="0.4s" href="#"><i
                                    class="linearicons-pulse"></i>
                                Symptom Checker</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="media isolation_item wow fadeInUp">
                    <div class="isolation_person_img">
                        <img src="<?= BASEURL; ?>/assets/images/symptom/isolation_man.png" alt=""/>
                    </div>
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="four-tab" data-toggle="tab" href="#four"
                                               role="tab" aria-controls="four" aria-selected="false">How is the
                                                virus spread?</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="five-tab" data-toggle="tab" href="#five"
                                               role="tab" aria-controls="five" aria-selected="false">What are the
                                                symptoms?</a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="four2-tab" data-toggle="tab" href="#four2"
                                               role="tab" aria-controls="four2" aria-selected="false">How is the
                                                virus spread?</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab3" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="four3-tab" data-toggle="tab" href="#four3"
                                               role="tab" aria-controls="four3" aria-selected="false">How is the
                                                virus spread?</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="four4-tab" data-toggle="tab" href="#four4"
                                               role="tab" aria-controls="four4" aria-selected="false">How is the
                                                virus spread?</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab5" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="four5-tab" data-toggle="tab" href="#four5"
                                               role="tab" aria-controls="four5" aria-selected="false">How is the
                                                virus spread?</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab6" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="four6-tab" data-toggle="tab" href="#four6"
                                               role="tab" aria-controls="four6" aria-selected="false">How is the
                                                virus spread?</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab7" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="four7-tab" data-toggle="tab" href="#four7"
                                               role="tab" aria-controls="four7" aria-selected="false">How is the
                                                virus spread?</a>
                                        </li>
                                        <li class="nav-item">
            ...
            <div class="col-lg-6">
                <div class="app_mobile">
                    <div class="mobile_image">
                        ...
                        <img class="wow fadeInUp" data-wow-delay="400ms" src="<?= BASEURL; ?>/assets/images/mobile-2.png" alt=""/>
                    </div>
